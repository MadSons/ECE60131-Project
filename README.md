...
The model is trained as a generative model: it defines an explicit latent variable model 

$$\hat{p}_\theta(x,y|c)$$ 
and learns 
$$\theta$$
by maximizing a variational lower bound on the conditional 
log-likelihood 
$$\log \hat{p}_\theta(y|c)$$.
