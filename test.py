...
def parse_config():
    ...
    parser.add_argument("--model", default='pretrained_models/MANTRA/model_IRM_statedict.pt')
    parser.add_argument("--visualize_dataset", default=False)
    parser.add_argument("--saved_memory", default=True)
    parser.add_argument("--memories_path", default='mantra_files/pretrained_models/MANTRA/memories/')
