...
class Trainer:
    def __init__(self, config):
        ...
        # model
        self.mem_n2n = model_encdec(self.settings).to(self.device)
    ...
    def fit(self):
        ...
        for epoch in range(self.start_epoch, config.max_epochs):
            ...
            if (epoch + 1) % 5 == 0:
                ...
                if val_loss < self.best_val_loss:
                    ...
                    torch.save(self.mem_n2n.state_dict(), self.folder_test + 'model_ae_best_' + self.name_test)

                # Save model checkpoint
                #if (epoch + 1) % 20 == 0:
                #    torch.save(self.mem_n2n.state_dict(), self.folder_test + 'model_ae_epoch_' + str(epoch) + '_' + self.name_test)
        ...
        torch.save(self.mem_n2n.state_dict(), self.folder_test + 'model_ae_' + self.name_test)
